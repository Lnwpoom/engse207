...
const init = async () => {
    ...
    var fs = require('fs');                                  //เป้นการตั้งตัวแปร ssh ขึ้นมาเพื่อให้อ่าน file server.key & server.crt
    ...
    server.route({                                                                      //patern ของการสร้าง api ten point ของแต่ละอัน
        method: 'GET',
        path: '/',
        config: {
            cors: {
